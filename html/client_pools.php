...
//----------------------------------------------------------------------------
// Xac thuc thong tin dang nhap Client
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            if (vm.status=='NO_FREE_VMS'){
                ...
                $("#warningbox").html("<strong><?php echo _("Warning!");?></strong> <?php echo _("No free VMs availableeeeeeeeeeeeeeee.");?><a class=\"close\" href=\"#\"  onclick=\"$('#warningbox').addClass('hidden')\">&times;</a>");
                $("#warningbox").removeClass('hidden');
                retries=0;
                clearInterval(checker_object);
            }
